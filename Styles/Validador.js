...
if(verificador > 0)
{
	...
	{
		document.getElementById("valido").innerHTML = '<b style="color:DarkGreen;">cedula valida</b>';
	}
	else
	{
		document.getElementById("valido").innerHTML = '<b style="color:Crimson;">cedula invalida</b>';
	}
